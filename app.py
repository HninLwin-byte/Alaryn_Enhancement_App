...
def hifigan_wavlm(pretrained=True, progress=True, prematched=True, device='cuda') -> HiFiGAN:
    ...
    if pretrained:
        if prematched:
            model_path = "/Users/krislwin/Documents/fast_api/fastapi_project/prematch_g_02500000.pt"
        else:
...
def wavlm_large(pretrained=True, progress=True, device='cuda') -> WavLM:
    ...
    #     progress=progress
    # )
    checkpoint = "/Users/krislwin/Documents/fast_api/fastapi_project/WavLM-Large.pt"
